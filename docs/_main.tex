...
\begin{dedication}
  Dedicate this thesis to someone here.
\end{dedication}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(}\StringTok{"figures/beltcrest.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (knitr}\OperatorTok{::}\NormalTok{opts\_knit}\OperatorTok{$}\KeywordTok{get}\NormalTok{(}\StringTok{\textquotesingle{}rmarkdown.pandoc.to\textquotesingle{}}\NormalTok{) }\OperatorTok{==}\StringTok{ \textquotesingle{}latex\textquotesingle{}}\NormalTok{)\{}
