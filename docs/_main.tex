...
\title{Investigating the use of designer pentatricopeptide repeat proteins as molecular tools.}
\author{Brady Addison Johnston\\
\small Bachelor of Science (Hons)}
\college{School of Molecular Sciences}
\supervisors{\large

Supervisors: \linebreak
Prof Charlie Bond \linebreak
Dr.~Jason Schmidberger \linebreak 
Prof Ian Small}
...
\begin{dedication}
  To all the proteins I ever loved.
\end{dedication}
...
\hypertarget{matmet}{%
\chapter{Materials and Methods}\label{matmet}}

\minitoc

Recipes for generic materials and methods are described in Sambrook \emph{et al} are included in the Appendix.
...
\begin{longtable}[]{@{}ll@{}}
\caption{\label{tab:chemicaltable} Now a caption here.}\tabularnewline
\toprule
...
\midrule
\endhead
Salt & NaCl\tabularnewline
Water & H2O\tabularnewline
\bottomrule
\end{longtable}

\hypertarget{e.-coli-strains}{%
\section{\texorpdfstring{\emph{E. coli} strains}{E. coli strains}}\label{e.-coli-strains}}

Genomes for the used bacterial strains can be found in table \ref{tab:bacteriatable}.

\begin{longtable}[]{@{}ll@{}}
\caption{\label{tab:bacteriatable}Bacerial genomes that were used in this study, and their relevant qualities.}\tabularnewline
\toprule
name & genome\tabularnewline
\midrule
\endfirsthead
\toprule
name & genome\tabularnewline
\midrule
\endhead
bacA & AAAAAA\tabularnewline
bacB & fjdskla;fjklds;a\tabularnewline
\bottomrule
\end{longtable}
...
\caption{\label{tab:extable}A Tale of Two Tables.}\tabularnewline
\toprule
...
\midrule
\endhead
Mazda RX4 & 21.0 & 6 & 160\tabularnewline
Mazda RX4 Wag & 21.0 & 6 & 160\tabularnewline
Datsun 710 & 22.8 & 4 & 108\tabularnewline
Hornet 4 Drive & 21.4 & 6 & 258\tabularnewline
Hornet Sportabout & 18.7 & 8 & 360\tabularnewline
\bottomrule
\end{longtable}

\hypertarget{media-and-buffers}{%
\section{Media and Buffers}\label{media-and-buffers}}

Some buffer content is now stored here.

\hypertarget{molecular-biology-methods}{%
\section{Molecular Biology Methods}\label{molecular-biology-methods}}
...
{\centering \includegraphics{_main_files/figure-latex/mtcarsplot-1} 

}

\caption{Lots of information about cars, how weird is that!}\label{fig:mtcarsplot}
\end{figure}

\hypertarget{plasmid-constructs}{%
\subsection{Plasmid Constructs}\label{plasmid-constructs}}

\hypertarget{petm-11-bacetial-expression-vector}{%
\subsubsection{pETM-11 Bacetial Expression Vector}\label{petm-11-bacetial-expression-vector}}
...
\hypertarget{petm-20-bacterial-expression-vector}{%
\subsubsection{pETM-20 Bacterial Expression Vector}\label{petm-20-bacterial-expression-vector}}
...
\hypertarget{plasmid-transformations}{%
\subsection{Plasmid Transformations}\label{plasmid-transformations}}

\hypertarget{plasmid-propagation-and-pufication}{%
\subsection{Plasmid propagation and pufication}\label{plasmid-propagation-and-pufication}}

\hypertarget{amplified-dna-via-pcr}{%
\subsection{Amplified DNA via PCR}\label{amplified-dna-via-pcr}}

\hypertarget{restriction-enzyme-digests}{%
\subsection{Restriction Enzyme Digests}\label{restriction-enzyme-digests}}

\hypertarget{dna-gel-extraction}{%
\subsection{DNA Gel Extraction}\label{dna-gel-extraction}}

\hypertarget{dna-ligation}{%
\subsection{DNA Ligation}\label{dna-ligation}}

\hypertarget{sequencing}{%
\subsection{Sequencing}\label{sequencing}}

\hypertarget{protein-biochemical-methods}{%
\section{Protein Biochemical Methods}\label{protein-biochemical-methods}}

\hypertarget{sds-page-gel}{%
\subsection{SDS PAGE Gel}\label{sds-page-gel}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(}\StringTok{"figures/captain.jpeg"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include\_graphics}\NormalTok{(}\StringTok{"figures/pdf\_example/Lyngs2020\_FB.pdf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{pages \textless{}{-}}\StringTok{ }\KeywordTok{list.files}\NormalTok{(}\StringTok{"figures/pdf\_example/split"}\NormalTok{, }\DataTypeTok{full.names =} \OtherTok{TRUE}\NormalTok{)}
